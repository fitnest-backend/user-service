...
/**
 * Controller for handling file uploads and storage operations.
 * Provides endpoints for uploading files to the storage service.
 */
@RestController
...
public class FileController {
    ...
    @PostMapping("/upload")
    public ResponseEntity<az.fitnest.user.shared.dto.ApiResponse<String>> uploadFile(
            @Parameter(description = "File to upload") @RequestParam("file") MultipartFile file) {
        String url = fileStorageService.saveFile(file);
        return ResponseEntity.ok(az.fitnest.user.shared.dto.ApiResponse.success(url));
    }
}
