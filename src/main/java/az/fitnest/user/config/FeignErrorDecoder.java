...
import az.fitnest.user.shared.exception.InternalServerException;
...
public class FeignErrorDecoder implements ErrorDecoder {
    ...
    public Exception decode(String methodKey, Response response) {
        ...
        return switch (response.status()) {
            ...
            case 403 -> new az.fitnest.user.shared.exception.ForbiddenException("Access denied to downstream service");
