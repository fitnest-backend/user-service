...
public class GoalReferenceController {
    ...
    @Operation(summary = "Create a new goal reference", description = "Creates a new goal reference. Requires admin privileges.")
    @PostMapping
    ...
    @Operation(summary = "Update a goal reference", description = "Updates an existing goal reference. Requires admin privileges.")
    @PutMapping("/{code}")
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    ...
    @Operation(summary = "Delete a goal reference", description = "Deletes a goal reference. Requires admin privileges.")
    @DeleteMapping("/{code}")
    @PreAuthorize("hasRole('ROLE_ADMIN')")
